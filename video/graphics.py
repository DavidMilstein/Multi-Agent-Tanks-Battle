...
TANK_BASE = pygame.image.load(os.path.join('video', 'pics', 'tank.png'))
TANK_TOWER = pygame.image.load(os.path.join('video', 'pics', 'tank_tower.png'))
...
img_tank_base = pygame.transform.scale(TANK_BASE, (tank_width, tank_height))  # Resize the image
img_tank_tower = pygame.transform.scale(TANK_TOWER, (round(tower_width), round(tower_height)))
